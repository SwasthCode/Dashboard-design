...
export default function StepTwo() {
    return (
        <div>
            <PageMeta
                title="Onboarding Step 2 | TailAdmin - React.js Admin Dashboard"
                description="This is the Onboarding Step 2 page for TailAdmin - React.js Tailwind CSS Admin Dashboard Template"
            />
