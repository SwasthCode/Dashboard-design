                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-800 relative min-h-[100px]">
                            {loading ? (
                                <tr className="animate-pulse">
                                    <td colSpan={5} className="px-4 py-10 text-center text-gray-500 h-[400px]">
                            ...
                            {!loading && currentRoles.map((role) => (
                                <tr key={role._id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group">
                                    ...
                                    <td className="px-4 py-3 whitespace-nowrap">
                                        <span
                                            className={`px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded-full border border-transparent ${role.status === "active" || role.is_active === true
