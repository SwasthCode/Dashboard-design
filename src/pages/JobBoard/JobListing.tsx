...
export default function JobListing() {
    return (
        <div>
            <PageMeta
                title="Job Listing | TailAdmin - React.js Admin Dashboard"
                description="This is the Job Listing page for TailAdmin - React.js Tailwind CSS Admin Dashboard Template"
            />
