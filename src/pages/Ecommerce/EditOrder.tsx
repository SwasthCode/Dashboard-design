...
export default function EditOrder() {
    ...
    if (orderLoading && !selectedOrder) return <div className="flex justify-center p-10"><DotLoading /></div>;
    if (!selectedOrder && !orderLoading) return <div className="p-10 text-center">Order not found</div>;
