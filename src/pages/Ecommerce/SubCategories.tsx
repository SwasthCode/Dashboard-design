...
export default function SubCategories() {
    ...
    const buildFilter = useCallback(() => {
        ...
        if (searchQuery) {
            ...
            filter.$or = [
                ...
                { category_id: { $in: matchingCategoryIds } },
        ...
        return filter;
    }, [searchQuery, selectedStatus, selectedCategory, selectedBrand, startDate, endDate, categories, brands]);
    ...
    const handleFilterChange = ({ search, startDate: start, endDate: end, status, category, brand }: any) => {
                ...
                <div className={`overflow-x-auto ${MIN_TABLE_HEIGHT}`}>
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-800 relative min-h-[100px]">
                            ...
                            {!loading && currentSubCategories.map((subCategory, i) => (
                                <tr
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 whitespace-nowrap">
                                        <span
                                            className={`px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded-full border border-transparent ${(subCategory.status || "inactive").toLowerCase() === "active"
