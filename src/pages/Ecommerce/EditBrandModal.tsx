...
export default function EditBrandModal({ isOpen, onClose, brand }: EditBrandModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await dispatch(updateBrand({ id: brand._id, data })).unwrap();
            onClose();
        } catch (err: any) {
            setError(err || "Failed to update brand");
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="fixed inset-0 z-99999 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-lg shadow-2xl border border-gray-100 dark:border-gray-800">
                <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-gray-50/50 dark:bg-gray-800/50 rounded-t-2xl">
                    <h3 className="text-xl font-bold text-gray-800 dark:text-white">Edit Brand</h3>
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-xs text-gray-500 space-y-1">
                                    <p className="font-medium text-gray-700 dark:text-gray-300">Change logo</p>
