...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Shop 2", path: "/shop-2", pro: false },
      { name: "Single Product", path: "/single-product", pro: false },
      { name: "Cart", path: "/cart", pro: false },
      { name: "Cart 2", path: "/cart-2", pro: false },
      { name: "Cart 3", path: "/cart-3", pro: false },
