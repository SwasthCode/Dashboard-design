...
export default function UserMetaCard() {
  ...
  const handleSave = () => {
    ...
    console.log("Saving changes...", { profileImage });
    closeModal();
  };
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] w-full m-4 mx-4 md:mx-auto mt-4 md:mt-0 mb-4 md:mb-0">
            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                  <div className="relative block w-full cursor-pointer appearance-none rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50/50 py-6 px-4 dark:border-gray-800 dark:bg-gray-800/30">
                    <input
                      type="file"
                      accept="image/*"
                    ...
                    <div className="flex flex-col items-center justify-center space-y-2">
                      <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {profilePreview && (
                      <div className="relative group h-16 w-16 border rounded-xl overflow-hidden border-gray-200 dark:border-gray-700 shadow-sm transition-all hover:shadow-md">
